...
/*
* A Minimax algorithm to calculate the AI move.
* */
public class Minimax {
    ...
    public Move MiniMax(Board board) {
        ...
        //If X plays then it wants to MAXimize the heuristics value
        if (playerLetter == Board.X) {
            return max(new Board(board), 0);
        }
        //If  O plays then it wants to MINimize the heuristics value
        else {
    ...
    public Move max(Board board, int depth) {
        ...
        ArrayList<Board> children = new ArrayList<>(board.getChildren(Board.X));
    ...
    //Min works the same way max does
    public Move min(Board board, int depth) {
        ...
        ArrayList<Board> children = new ArrayList<>(board.getChildren(Board.O));
